...
public class BleDefinedUUIDs {
	...
	public static class Service {
		...
		final static public UUID RFDUINO_UUID_SERVICE 	  = UUID.fromString("00002220-0000-1000-8000-00805f9b34fb");
	};
	...
	public static class Characteristic {
		...
		final static public UUID RFDUINO_UUID_RECEIVE 	  = UUID.fromString("00002221-0000-1000-8000-00805f9b34fb");
		final static public UUID RFDUINO_UUID_SEND 		  = UUID.fromString("00002222-0000-1000-8000-00805f9b34fb");
		final static public UUID RFDUINO_UUID_DISCONNECT  = UUID.fromString("00002223-0000-1000-8000-00805f9b34fb");
	}
	
	public static class Descriptor {
		final static public UUID CHAR_CLIENT_CONFIG       		= UUID.fromString("00002902-0000-1000-8000-00805f9b34fb");
		final static public UUID RFDUINO_UUID_CLIENT_CONFIG 	= UUID.fromString("00002902-0000-1000-8000-00805f9b34fb");
	}
